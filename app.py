...
def owner_kb(d: dict) -> InlineKeyboardMarkup:
    mode_label = f"🔴 " + sc("DISABLE FREE MODE") if d.get("free_mode") else f"🟢 " + sc("ENABLE FREE MODE")
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="⚙️ " + sc("SETTINGS"), callback_data="owner:settings"),
...
def user_kb() -> InlineKeyboardMarkup:
    # Photo ke jaise: SEND SMS = green (full row), baaki blue/primary, BUY CREDITS = green
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="ℹ️ " + sc("INFO"), callback_data="user:info")],
    ])
