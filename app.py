            ...
            while msgs_left > 0 and not session.cancelled:
                ...
                for device in device_queue:
                    ...
                    for sim in sim_slots:
                        ...
                        # Attempt to send with fast failover (fb_put now has retry)
                        try:
                        ...
                        # else: no sleep, immediately try next device/SIM
                ...
                # If batch_sent == 0 and msgs_left > 0, all devices failed; increment counter and wait
